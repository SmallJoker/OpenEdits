...
RemotePlayer::RemotePlayer(peer_t peer_id, uint16_t protocol_version) :
	...
	rl_blocks(1, 2), // weight overwritten by Server::pkt_PlaceBlock
	rl_chat(1.25f, 3), // 1 chat message every 1.25 seconds
	rl_scriptevents(1 / 20.0f, 2) // 20 events per second
{
